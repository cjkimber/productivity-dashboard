...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    const { date, workoutType, workoutLabel, exercises, noData, rowingType, rowingValue, cardioNote, sessionSlot, sessionNotes, am } = req.body;
    ...
    const entry = { date, workoutType, workoutLabel, exercises: exercises || [], noData: !!noData, rowingType, rowingValue, cardioNote, sessionNotes, am: !!am, sessionSlot: slot, completedAt: new Date().toISOString() };
