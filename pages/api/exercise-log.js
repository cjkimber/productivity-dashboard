...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    const { date, workoutType, workoutLabel, exercises, noData, rowingType, rowingValue, xtDuration, xtCalories, cardioNote, sessionSlot, sessionNotes, am } = req.body;
    ...
    const entry = { date, workoutType, workoutLabel, exercises: exercises || [], noData: !!noData, rowingType, rowingValue, xtDuration, xtCalories, cardioNote, sessionNotes, am: !!am, sessionSlot: slot, completedAt: new Date().toISOString() };
